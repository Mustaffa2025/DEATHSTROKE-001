const {
  ...
  const settings = require('./settings') // Ensure config is loaded
...
const sessdata = settings.SESSION_ID.replace("POPKID;;;", '');
...
const port = process.env.PORT || 9090;
  ...
  callHandler(conn, settings.ANTICALL); // Pass conn and the anticall setting from config
  // ---------------------------------------------
